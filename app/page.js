              ...
              {!data.user && (
               ...
               {data?.user && (
                <div className="relative group">
                  <button className="flex items-center space-x-2 bg-purple-600 text-white hover:bg-purple-700 px-4 py-2 rounded-md text-sm font-medium">
                    <span>{data.user.email}</span>
                    <ChevronDown className="h-4 w-4" />
                  </button>
                  <div className="absolute right-0 mt-2 w-56 origin-top-right rounded-md bg-white shadow-lg border-1 ring-opacity-5 focus:outline-none opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-10">
                    <div className="py-1">
                      <Link
                        href="/dashboard"
          ...
          <div className="lg:grid lg:grid-cols-12 lg:gap-8">
            <div className="sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left">
              ...
              <p className="mt-3 text-base text-gray-600 sm:mt-5 sm:text-xl lg:text-lg xl:text-xl">
                Create a beautiful custom page for all your products and social
                links. Get powerful insights on how your audience interacts with
                your content.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:text-center">
            ...
            <p className="mt-4 max-w-2xl text-xl text-gray-600 lg:mx-auto">
              LinksDrive gives you all the tools to create, share, and analyze
                ...
                <div className="flow-root bg-gray-50 rounded-lg px-6 pb-8">
                  <div className="-mt-6">
                    ...
                    <p className="mt-5 text-base text-gray-600">
                      Create beautiful, branded pages that showcase all your
                      important links in one place. Customize colors, fonts, and
              ...
              <div className="pt-6">
                <div className="flow-root bg-gray-50 rounded-lg px-6 pb-8">
                  <div className="-mt-6">
                    ...
                    <p className="mt-5 text-base text-gray-600">
                      Get powerful insights on how your audience interacts with
                      your links. Track clicks, geographic data, referral
                      sources, and more.
                    </p>
                  </div>
                </div>
              ...
              <div className="pt-6">
                <div className="flow-root bg-gray-50 rounded-lg px-6 pb-8">
                  <div className="-mt-6">
                    ...
                    <p className="mt-5 text-base text-gray-600">
                      Share your LinksDrive page across all your social
                      platforms with a single, memorable URL. Update once,
                      change everywhere.
                    </p>
                  </div>
                </div>
              ...
              <div className="pt-6">
                <div className="flow-root bg-gray-50 rounded-lg px-6 pb-8">
                  <div className="-mt-6">
                    ...
                    <p className="mt-5 text-base text-gray-600">
                      Our AI-powered insights help you optimize which links to
                      feature and when, maximizing your conversion rates.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="pt-6">
                <div className="flow-root bg-gray-50 rounded-lg px-6 pb-8">
                  <div className="-mt-6">
                    ...
                    <p className="mt-5 text-base text-gray-600">
                      Your LinksDrive page looks great on any device, ensuring a
                      seamless experience for all your visitors.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="pt-6">
                <div className="flow-root bg-gray-50 rounded-lg px-6 pb-8">
                  <div className="-mt-6">
                    ...
                    <p className="mt-5 text-base text-gray-600">
                      Control every aspect of your page, from SEO settings to
                      privacy options. You're in complete control.
                    </p>
                  </div>
                </div>
              </div>
      ...
      <section id="how-it-works" className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:text-center">
            ...
            <p className="mt-4 max-w-2xl text-xl text-gray-600 lg:mx-auto">
              Setting up your LinksDrive page is quick and easy. You'll be up
            ...
            <div className="space-y-10 md:space-y-0 md:grid md:grid-cols-3 md:gap-x-8 md:gap-y-10">
              <div className="relative">
                ...
                <div className="ml-16">
                  ...
                  <p className="mt-2 text-base text-gray-600">
                    Sign up for LinksDrive in seconds. No credit card required
              ...
              <div className="relative">
                ...
                <div className="ml-16">
                  ...
                  <p className="mt-2 text-base text-gray-600">
                    Add all your important links - social profiles, products,
                    portfolio items, and more. Organize them however you like.
                  </p>
                </div>
              </div>
              ...
              <div className="relative">
                ...
                <div className="ml-16">
                  ...
                  <p className="mt-2 text-base text-gray-600">
                    Share your custom LinksDrive URL with your audience and
                    start tracking performance with our powerful analytics.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
            <div className="bg-gray-50 p-8 rounded-xl shadow-sm">
              ...
              <p className="text-gray-700">
                "LinksDrive has completely transformed how I share my content.
                The analytics have helped me understand what my audience really
                wants to see."
              </p>
            </div>
            ...
            <div className="bg-gray-50 p-8 rounded-xl shadow-sm">
              ...
              <p className="text-gray-700">
                "As someone with multiple businesses, having one place to
                organize all my links has been a game-changer. My conversion
                rates have increased by 35%!"
              </p>
            </div>
            ...
            <div className="bg-gray-50 p-8 rounded-xl shadow-sm">
              ...
              <p className="text-gray-700">
                "The customization options are incredible. I was able to create
                a page that perfectly matches my brand, and my followers love
                how easy it is to find my content."
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 lg:flex lg:items-center lg:justify-between">
          <h2 className="text-3xl font-extrabold tracking-tight text-white sm:text-4xl">
            ...
            <span className="block text-purple-200">
              Create your LinksDrive page today.
            </span>
          </h2>
          ...
          <div className="xl:grid xl:grid-cols-3 xl:gap-8">
            <div className="space-y-8 xl:col-span-1">
              ...
              <p className="text-gray-400 text-base">
                Making it easy to share and track all your important links in
                one beautiful page.
              </p>
